...
function ft_search_sidebar() {
  $sidebar[] = array(
    "id" => "search_1",
    "content" => '<div class="section" id="searchbox" style="       background-color: #FFFFFF;
...
padding:15px;">
  		...
  		<form action="" method="post" id="searchform" >
  			<div>
  				<input type="text" name="q" id="q" size="16" value="'.$_REQUEST['q'].'" /><br/><br/>
  				<input type="button" id="dosearch" value="'.t('Search').'" />
  			</div>
  			<div id="searchoptions">
  				<input type="checkbox" name="type" id="type" checked="checked" /> '.t('Search this folder and below').'	</div>
