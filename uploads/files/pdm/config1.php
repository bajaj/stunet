...
function ft_settings_external_load($file) {
  $ft = array();
  $ft['settings'] = array();
  $ft['groups'] = array();
  $ft['users'] = array();
  ...
  define("USERNAME", "bajaj"); // Your default username.
  define("PASSWORD", "bajaj"); // Your default password.

  $ft["settings"]["DIR"]               = $file; // Your default directory. Do NOT include a trailing slash!
  ...
  $ft["settings"]["PLUGINDIR"]         = FRAMEWORK_PATH.'uploads/files/pdm/plugins'; // Set to the path to your plugin folder. Do NOT include a trailing slash!
...
$ft['users']['priyank'] = array(
    'password' => 'priyank',
    'group' => 'friend'
  );
  
 $ft['users']['ritesh'] = array(
    'password' => 'ritesh',
    'group' => 'self'
  ); 
  
$ft['groups']['self'] = array(
	'DIR'=>'ritesh',
   ); 
