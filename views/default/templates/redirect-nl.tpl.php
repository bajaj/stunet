...
<head> 
	<base href="{siteurl}" />
	<title>Dash Board! The network for students!</title> 
	...
	<script type="text/javascript" src="views/default/jquery.uniform.js"></script>
        ...
        <script type="text/javascript" src="views/default/custom-nl.js"></script>
        <link rel="stylesheet" type="text/css" href="views/default/style-nl.css" />
</head> 
