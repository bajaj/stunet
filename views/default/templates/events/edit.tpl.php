...
<form action="event/update/{ID}" method="post">
<table id="event">
    <tr>
        <th>Name</th>
    ...
    <tr>
        <th>Type of event</th>
        <td><select name="type" id="type"><option value="Public">Public</option><option value="Private">Private</option></select></td>
    </tr>
    ...
    <tr>
        ...
        <tr>
            <th>Start Time</th>
            <td><input type="text" id="selecttime" name="start_time" value="{start_time}"/></td>
        </tr>

        <tr>
            <th>End Time</th>
            <td><input type="text" id="selecttime2" name="end_time" value="{end_time}"/></td>
        </tr>

        <tr>
            <th>Description</th>
     
        <td><textarea name="description" class="uniform" cols="45" rows="6">{description}
        </textarea></td>
        </tr>
        ...
        <tr><th>Invite Groups</th><td id="groups">
...
<tr><th></th><td>
<input type="submit" name="" value="Update event"/></td></tr>

</form>
                                <tr><th>&nbsp;</th><td>
<form action="event/delete/{ID}" method="post" onsubmit="return validate();">
...
<SCRIPT language="javascript">
    function validate()
    {
        var val=confirm('Are you sure you want to delete this event?');
        if(val) return true;
        else return false;
    }
$(function(){
