				...
				<br/>
					...
					<table id="messages1">
						...
						<!-- START messages -->
						<tr class="read">
							<td><a href="messages/view/{ID}">{recipient_fname} {recipient_lname}</a></td>
						...
						<!-- END grp_messages -->
                                ...
                                <script>
                                      $(document).ready(function(){
                                        ...
                                        document.getElementById("messages").innerHTML='<div id="searchinfo">You have no messages in your sent items</div>';
                                    });  
                            </script>
                               <br/><br/><hr/><br/>
                               <div class="messages">
