...
var YoutubeDialog = {
    ...
    insert: function () {
        ...
        tinyMCEPopup.editor.execCommand('mceInsertContent', false, '<iframe title="YouTube video player" class="youtube" width="430" height="253" src="http://www.youtube.com/embed/'+code+'" frameborder="0" allowfullscreen></iframe>');
        tinyMCEPopup.close();
    }
};
