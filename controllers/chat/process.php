  ...
  $log = array();
    ...
    switch ($function) {
    	 ...
    	 case ('send'):
			 ...
			 $replacements = array("<img src='controllers/chat/smiles/smile.gif'/>", "<img src='smiles/bigsmile.png'/>", "<img src='smiles/tongue.png'/>", "<img src='smiles/tongue.png'/>", "<img src='smiles/sad.png'/>");
